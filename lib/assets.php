...
function project_name_assets_dev(){
  ...
  wp_enqueue_style( 'project-name-main-stylesheet', "{$ASSETS}/css/main.min.css", array(), $style_version, 'all' );
  wp_enqueue_script( 'project-name-vendor-script', "{$ASSETS}/js/vendor.min.js", array(), $vendor_version, true );
  wp_enqueue_script( 'project-name-custom-script', "{$ASSETS}/js/custom.min.js", array('project-name-vendor-script'), $custom_version, true );
}
